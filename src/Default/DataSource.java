...
public class DataSource {
    ...
    public static List<Party> partyList(){
        Party party1 = new Party(300, "Casual", "Sweet Red",
                        new Place("The Bridge", 8,
                                new Address("1000 4th nt street", "Spring Field", "IO", "34565")), LocalDate.of(2020,03,03),
                                    new User("Rose Smith"));

        Party party2 = new Party(34, "Costume", "Caribean Wynne",
                new Place("Three Trees", 7,
                        new Address("1000 4th nt street", "Spring Field", "IO", "34565")), LocalDate.of(2020,03,03),
                new User("Grace Phillip"));

        Party party3 = new Party(390, "Casual", "The Blue on Your Ayes",
                new Place("The Mountain", 9,
                        new Address("1000 4th nt street", "Spring Field", "IO", "34565")), LocalDate.of(2020,03,03),
